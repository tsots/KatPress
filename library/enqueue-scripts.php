...
if ( ! function_exists( 'katpress_asset_path' ) ) :
	function katpress_asset_path( $filename ) {
...
if ( ! function_exists( 'katpress_scripts' ) ) :
	function katpress_scripts() {

		// Enqueue the main Stylesheet.
		wp_enqueue_style( 'main-stylesheet', get_template_directory_uri() . '/dist/assets/css/' . katpress_asset_path( 'app.css' ), array(), '2.10.4', 'all' );
	...
	add_action( 'wp_enqueue_scripts', 'katpress_scripts' );
endif;
